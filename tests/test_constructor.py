...
class TestConstructorPage:
    ...
    def test_click_on_random_ingredient_details_loaded(self, driver):
        ...
        ingredient =constructor_page.return_random_ingredient()
        constructor_page.scroll_to_element_by_element(ingredient)
        ingredient.click()
        assert constructor_page.check_ingredient_details_opened(), 'Детали ингредиента не открылись'
    ...
    def test_click_on_close_ingredient_details_button_details_closed(self, driver):
        ...
        constructor_page.scroll_to_element_by_element(ingredient)
        ingredient.click()
        constructor_page.click_on_close_ingredient_details_button()
        assert constructor_page.check_ingredient_details_closed(), 'Детали ингредиента не закрылись'
    ...
    def test_add_ingredient_to_order_counter_changed(self, driver):
        constructor_page = ConstructorPage(driver)
        constructor_page.open_constructor_page()
        counter_initial_value = constructor_page.get_basket_counter_value()
        ingredient = constructor_page.return_random_ingredient()
        constructor_page.scroll_to_element_by_element(ingredient)
        constructor_page.drag_and_drop_to_basket(ingredient)
        counter_final_value = constructor_page.get_basket_counter_value()
