...
class TestOrderListPage:
    ...
    def test_click_on_constructor_link_constructor_page_opened(self, driver):
        ...
        constructor_page.click_on_order_list_link()
    ...
    def test_check_order_details_displayed(self, driver, generate_user_data):
        ...
        order = order_list_page.get_random_order_from_list()
        order.click()
        assert order_list_page.check_order_details_opened(), 'Детали заказа не отображаются'
